...
const Products = () => {
  ...
  return (
    <div id="p" className="max-w-screen-2xl container mx-auto xl:px-28 px-4 mb-12">
      <h2 className="text-3xl mt-20 font-semibold capitalize text-center my-2">
        Select What You Want From Below
      </h2>
