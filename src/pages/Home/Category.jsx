    ...
    <div className="max-w-screen-2xl container xl:px-28 px-4 py-16">
      ...
      <div className="flex items-center justify-around flex-wrap gap-4 py-5">
        {companyLogo.map(({ id, img }) => (
          <div key={id}>
            <img src={img} alt="" className="hover:scale-125 transition-all cursor-pointer duration-200" onClick={top}/>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 mt-8">
        ...
        <div>
          <Link to="/">
            <img src="/images/category/image1.png" alt="" className="w-full hover:scale-105 transition-all duration-200 cursor-pointer" onClick={top} />
          </Link>
        </div>
